...
var https = require('https'),
    zlib = require('zlib'),
    url = require('url'),
    pkg = require('disconnect/package.json'),
    error = require('disconnect/lib/error.js'),
    util = require('disconnect/lib/util.js');
...
var queue = require('disconnect/lib/queue.js')({
...
DiscogsClient.prototype.oauth = function() {
    var OAuth = require('disconnect/lib/oauth.js');
...
DiscogsClient.prototype.database = function() {
    return require('disconnect/lib/database.js')(this);
};
...
DiscogsClient.prototype.marketplace = function() {
    return require('disconnect/lib/marketplace.js')(this);
};
...
DiscogsClient.prototype.user = function() {
    return require('disconnect/lib/user.js')(this);
};
